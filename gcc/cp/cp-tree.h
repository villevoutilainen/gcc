...
#define profiles_identifier		cp_global_trees[CPTI_PROFILES_IDENTIFIER]
...
extern void tsubst_regenerated_contract_specifiers (tree, tree, tree);
...
extern const struct scoped_attribute_specs profiles_attribute_table;
