// D4324/Stage 4d: companion to d4324-gimple-symbolic-predicate-field-
// alias-invalidated-unknown.C with no intervening mutation -- confirms
// establish-then-consult *through* a field slot actually works on the
// GIMPLE engine (cg_field_slot_identity resolving on the consult
// side), not merely that Rule 2 invalidation reaches it. See .claude/
